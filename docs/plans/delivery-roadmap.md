...
- `release`、`archive_tree_release`、`system_package|apt`、`pip`、`npm_global`、`workspace_package`、`cargo_install`、`rustup_component`、`go_install`、`uv`、`uv_python`、`uv_tool` 已纳入统一 plan 执行面。
