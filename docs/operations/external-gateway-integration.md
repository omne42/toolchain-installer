...
- 参与条件
  - 当前只有 `country=CN` 且目标是无 query/fragment 的 `https://github.com/git-for-windows/git/releases/download/<tag>/<asset>` 这类精确 `git-for-windows` release 资产 URL 时，才会生成网关候选。
